...
fn test_all_deps_used_no_changes() {
    ...
    assert_eq!(exit_code, ExitCode::SUCCESS, "Should not detect unused dependencies when all are used");
...
fn test_complex_workspace_unused_deps() {
    ...
    assert_eq!(exit_code, ExitCode::FAILURE, "Should detect unused dependencies in complex workspace");
}
...
fn test_complex_workspace_unused_deps_fix() {
    ...
    assert!(!workspace_toml.contains("unused-dep-1"), "Unused workspace dependency should be removed");
    assert!(!workspace_toml.contains("unused-dep-2"), "Unused workspace dependency should be removed");
