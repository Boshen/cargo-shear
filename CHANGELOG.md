...
### <!-- 1 -->🐛 Bug Fixes
- report Cargo package version ([#561](https://github.com/Boshen/cargo-shear/pull/561)) (by @Boshen)
...
### <!-- 1 -->🐛 Bug Fixes
- mark public enums as `#[non_exhaustive]` to prevent major version bumps (by @Boshen)
