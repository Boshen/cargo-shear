...
## [1.1.5](https://github.com/Boshen/cargo-shear/compare/v1.1.4...v1.1.5) - 2024-12-01

### Other

- *(deps)* update rust crates ([#102](https://github.com/Boshen/cargo-shear/pull/102))
- *(deps)* update dependency rust to v1.83.0 ([#100](https://github.com/Boshen/cargo-shear/pull/100))
